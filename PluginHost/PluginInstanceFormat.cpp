...
PluginInstanceFormat::InternalPluginFactory::InternalPluginFactory (const std::initializer_list<Constructor>& constructorsIn)
...
std::unique_ptr<AudioPluginInstance> PluginInstanceFormat::InternalPluginFactory::createInstance (const String& name) const
{
